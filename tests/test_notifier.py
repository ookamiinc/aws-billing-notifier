...
class NotifierTest(unittest.TestCase):
    def test_message_payload(self):
        services_json = {'Metrics': [{'Namespace': 'AWS/Billing',
                                     ...
                                     {'Namespace': 'AWS/Billing',
                                      ...
                                      'Dimensions': [{'Name': 'ServiceName',
                                                     ...
                                                     {'Name': 'Currency',
                                                      'Value': 'USD'}]}],
                         'ResponseMetadata': {'RequestId': 'a21fa897-a829-11e9-9006-abab1ff1cace',
                                              'HTTPStatusCode': 200,
                                              'HTTPHeaders': {'x-amzn-requestid': 'a21fa897-a829-11e9-9006-abab1ff1cace',
                  ...
                  [
                      {'fallback': '今月のAWSの利用費は、1,558.0 USDです。',
                       ...
                       [
                           ...
                           {'title': 'AmazonSageMaker', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AWSConfig', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'awswaf', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AWSDataTransfer', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AWSSecretsManager', 'value': '1,558.0 USD', 'short': 'true'},
                           ...
                           {'title': 'AmazonRoute53', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AWSCloudTrail', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AmazonStates', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AWSMarketplace', 'value': '1,558.0 USD', 'short': 'true'},
                           {'title': 'AmazonCloudWatch', 'value': '1,558.0 USD', 'short': 'true'},
